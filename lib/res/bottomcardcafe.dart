...
class cafeBottomCard extends StatefulWidget {
  final int cartItemCount; 

  const cafeBottomCard({required this.cartItemCount});

  @override
  _cafeBottomCardState createState() => _cafeBottomCardState();
}

class _cafeBottomCardState extends State<cafeBottomCard> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant cafeBottomCard oldWidget) {
