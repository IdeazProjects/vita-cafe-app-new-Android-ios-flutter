...
class Riderbtmbar extends StatefulWidget {
  final int initialPageIndex;

  const Riderbtmbar({Key? key, this.initialPageIndex = 0}) : super(key: key);

  @override
  State<Riderbtmbar> createState() => _RiderbtmbarState();
}

class _RiderbtmbarState extends State<Riderbtmbar> {
      ...
      home: Scaffold(
        body: PageView(
          ...
          children: [
            ...
            Center(child: Text("Rider2")),
            Center(child: Text("Rider3")),
